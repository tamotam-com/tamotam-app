...
export default function MapScreen() {
  ...
  const [selectedStartDate, setSelectedStartDate] = useState<any | Date>(
    new Date(),
  );
  ...
  useEffect(() => {
    ...
    analytics().logEvent('custom_log', {
      description:
        '--- Analytics: screens -> MapScreen -> useEffect[error], error: ' +
        error,
    });
  ...
  const loadEvents: () => Promise<void> = useCallback(async () => {
    ...
    try {
      ...
      const eventsInJSONString: any = await AsyncStorage.getItem(
        'EVENTS_ASYNC_STORAGE',
      );
      ...
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> loadEvents -> try, eventsInJSONString: ' +
          eventsInJSONString,
      });
      try {
        expirationEventsDate = await AsyncStorage.getItem(
          'EXPIRATION_DATE_ASYNC_STORAGE',
        );
        expirationEventsDateParsed = new Date(JSON.parse(expirationEventsDate));

        analytics().logEvent('custom_log', {
          description:
            '--- Analytics: screens -> MapScreen -> loadEvents -> try -> try1, expirationEventsDate: ' +
            expirationEventsDate,
        });
        analytics().logEvent('custom_log', {
          description:
            '--- Analytics: screens -> MapScreen -> loadEvents -> try -> try1, expirationEventsDateParsed: ' +
            expirationEventsDateParsed,
        });
      } catch (error: unknown) {
        if (error instanceof Error) {
          analytics().logEvent('custom_log', {
            description:
              '--- Analytics: screens -> MapScreen -> loadEvents -> try -> catch1, error: ' +
              error,
          });
          crashlytics().recordError(error);
        ...
        analytics().logEvent('custom_log', {
          description:
            '--- Analytics: screens -> MapScreen -> loadEvents -> try -> finally1',
        });
      }
      ...
      if (!expirationEventsDate) {
        ...
        const cacheExpiryTimeInJSONString: string =
          JSON.stringify(cacheExpiryTime);
        try {
          await AsyncStorage.setItem(
            'EXPIRATION_DATE_ASYNC_STORAGE',
            cacheExpiryTimeInJSONString,
          );

          analytics().logEvent('custom_log', {
            description:
              '--- Analytics: screens -> MapScreen -> loadEvents -> try -> try2, cacheExpiryTimeInJSONString: ' +
              cacheExpiryTimeInJSONString,
          });
        } catch (error: unknown) {
          if (error instanceof Error) {
            analytics().logEvent('custom_log', {
              description:
                '--- Analytics: screens -> MapScreen -> loadEvents -> try -> catch2, error: ' +
                error,
            });
            crashlytics().recordError(error);
            setError(new Error(error.message));
          ...
          analytics().logEvent('custom_log', {
            description:
              '--- Analytics: screens -> MapScreen -> loadEvents -> try -> finally2',
          });
        }
      }
      ...
      if (
        new Date().getTime() >= expirationEventsDateParsed.getTime() ||
        eventsInJSONString === null
      ) {
        ...
        const promiseTicketmasterEvents: void = dispatch(
      ...
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> loadEvents -> try, new Date().getTime(): ' +
          new Date().getTime(),
      });
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> loadEvents -> try, eventsParsed: ' +
          eventsParsed,
      });
      ...
      if (error instanceof Error) {
        ...
        analytics().logEvent('custom_log', {
          description:
            '--- Analytics: screens -> MapScreen -> loadEvents -> catch, error: ' +
            error,
        });
        crashlytics().recordError(error);
        setError(new Error(error.message));
      ...
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> loadEvents -> finally',
      });
      setIsLoading(false);
    }
  ...
  useEffect(() => {
    analytics().logEvent('custom_log', {
      description:
        '--- Analytics: screens -> MapScreen -> useEffect[loadEvents]',
    });
    loadEvents();
  }, [loadEvents]);
  ...
  const getUserLocationHandler: () => Promise<void> = useCallback(async () => {
    analytics().logEvent('custom_log', {
      description:
        '--- Analytics: screens -> MapScreen -> getUserLocationHandler',
    });
    setError(new Error(''));
    setIsLoading(true);
    ...
    if (Platform.OS !== 'web') {
      ...
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> getUserLocationHandler, status: ' +
          status,
      });
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> getUserLocationHandler, Platform.OS: ' +
          Platform.OS,
      });
    }
    ...
    try {
      ...
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> getUserLocationHandler -> try, location.coords.latitude: ' +
      ...
      if (error instanceof Error) {
        ...
        analytics().logEvent('custom_log', {
          description:
            '--- Analytics: screens -> MapScreen -> getUserLocationHandler -> catch, error: ' +
            error,
        });
        crashlytics().recordError(error);
        setError(new Error(error.message));
      ...
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> getUserLocationHandler -> finally',
      });
      setIsLoading(false);
    }
  }, [dispatch, setError, setIsLoading]);
  ...
  useEffect(() => {
    analytics().logEvent('custom_log', {
      description:
        '--- Analytics: screens -> MapScreen -> useEffect[getUserLocationHandler]',
    });
  ...
  const saveEventHandler: (event: Event) => void = (event: Event) => {
    ...
    try {
      ...
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> saveEventHandler -> try, savedEvent: ' +
          savedEvents,
      });
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> saveEventHandler -> try, event: ' +
          event,
      });
      ...
      if (error instanceof Error) {
        ...
        analytics().logEvent('custom_log', {
          description:
            '--- Analytics: screens -> MapScreen -> saveEventHandler -> catch, error: ' +
            error,
        });
        crashlytics().recordError(error);
        setError(new Error(error.message));
      ...
      analytics().logEvent('custom_log', {
        description:
          '--- Analytics: screens -> MapScreen -> saveEventHandler -> finally',
      });
      setIsLoading(false);
    }
  };
  ...
  const onShowDatePicker: () => void = () => {
    analytics().logEvent('custom_log', {
      description:
        '--- Analytics: screens -> NewEventScreen -> onShowDatePicker, text: ',
    });
  ...
  //handling_filter_icon
  const _handleFilterIcon = () => {
...
const styles = StyleSheet.create({
  filterIconContainer: {position: 'absolute', top: 20, left: 20, zIndex: 999},
  modelView: {
    flexDirection: 'row',
